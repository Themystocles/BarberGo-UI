...
const Home = () => {
    ...
    const isLoading = userType === null || userType === undefined;
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-center px-4 bg-black bg-opacity-60">
                ...
                {isLoading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-4xl">
                        {/* 3 loaders ocupando cada slot */}
                        {[1, 2, 3].map((_, idx) => (
                            <div key={idx} className="bg-gray-800 bg-opacity-50 p-6 rounded-2xl shadow-lg flex items-center justify-center h-40">
